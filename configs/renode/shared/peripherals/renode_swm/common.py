# -*- coding: utf-8 -*-
"""Common Renode SWM helper utilities.

Provides the peripheral register model (`PReg`) and mock request/logging
objects used for static‑analysis linting.
"""
...
# Mock objects for Renode IDE static analysis (no‑op at runtime)
