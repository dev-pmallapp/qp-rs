...
/// ESP32-C3 GPIO Pin
pub struct Esp32C3Pin {
    pin: u8,
}

unsafe impl Send for Esp32C3Pin {}
unsafe impl Sync for Esp32C3Pin {}

impl Esp32C3Pin {
    /// Create a new Esp32C3Pin handle
    ///
    /// # Safety
...
impl embedded_hal::digital::ErrorType for Esp32C3Pin {
    type Error = HalError;
}

impl embedded_hal::digital::OutputPin for Esp32C3Pin {
...
impl embedded_hal::digital::InputPin for Esp32C3Pin {
