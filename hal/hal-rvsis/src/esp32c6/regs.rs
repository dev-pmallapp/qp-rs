//! ESP32-C6 peripheral register maps and base addresses

use hal::mmio::{RO, RW, WO};

// ESP32-C6 Peripheral Base Addresses
pub const GPIO_BASE:  usize = 0x6009_1000;
pub const SPI2_BASE:  usize = 0x6008_1000; // GP-SPI2
...
pub struct GpioRegs {
    ...
    pub out1:        RW<u32>,   // 0x010 (unused on C6 but kept for struct compatibility)
