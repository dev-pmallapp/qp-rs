...
unsafe impl Send for Esp32Spi {}
unsafe impl Sync for Esp32Spi {}

impl Esp32Spi {
    /// Create a new Esp32Spi handle
    ///
    /// # Safety
...
impl embedded_hal::spi::ErrorType for Esp32Spi {
    type Error = HalError;
}

impl embedded_hal::spi::SpiBus<u8> for Esp32Spi {
