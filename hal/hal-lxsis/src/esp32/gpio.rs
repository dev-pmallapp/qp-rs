...
unsafe impl Send for Esp32Pin {}
unsafe impl Sync for Esp32Pin {}

impl Esp32Pin {
    /// Create a new Esp32Pin handle
    ///
    /// # Safety
...
impl embedded_hal::digital::ErrorType for Esp32Pin {
    type Error = HalError;
}

impl embedded_hal::digital::OutputPin for Esp32Pin {
...
impl embedded_hal::digital::InputPin for Esp32Pin {
